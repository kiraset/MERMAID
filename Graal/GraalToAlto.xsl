...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="myTexts" select="document('../texts/qgraal_cm-w.xml')"/>
    ...
    <!-- Ignore <ex> inside <w> ONLY when it has @prev -->
    <xsl:template match="tei:w/tei:ex[@prev]"/>
